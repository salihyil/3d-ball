...
export default function Home() {
  ...
  const handleCreate = useCallback(() => {
    ...
    socket.emit('create-room', { nickname: nickname.trim(), matchDuration }, (res: { roomId: string }) => {
      setLoading(false);
      if (res.roomId) {
  ...
  const handleJoin = useCallback(() => {
    ...
    socket.emit('join-room', { roomId: roomCode.trim(), nickname: nickname.trim() }, (res: { success: boolean; error?: string }) => {
      setLoading(false);
      if (res.success) {
        sessionStorage.setItem('bb-nickname', nickname.trim());
    ...
    <>
      ...
      <div className="page-center">
        <div className="home-container">
          ...
          <div className="glass-card animate-in animate-in-delay-2" style={{ padding: '32px' }}>
